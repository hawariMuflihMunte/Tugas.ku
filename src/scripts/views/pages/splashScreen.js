            ...
            <div class="col-lg-4">
              <div class="card text-center m-lg-5 m-3">
                <div class="card-body p-4 my-3">
                  ...
                  <p>A task management application helps you organize your work more efficiently .</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card text-center m-lg-5 m-3">
                <div class="card-body p-4 my-3">
                  ...
                  <p> With a task management application, you can focus on the most important tasks and avoid less critical ones.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card text-center m-lg-5 m-3">
                <div class="card-body p-4 my-3">
                  ...
                  <p>with task management applications you can access your tasks wherever you are.</p>
                </div>
              </div>
            </div>
          </div>
